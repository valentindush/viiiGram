  ...
  return (
    <div className='h-full w-full p-4 overflow-hidden'>
        <div className='w-full flex items-center gap-2 border-2 p-1 px-2 rounded-xl sticy top-0'>
            ...
            <input onFocus={()=>setIsClicked(true)} onBlur={(()=>setIsClicked(false))} className= "w-full outline-none border-none text-sm p-1" autoComplete='off' value={searchInput} onChange={(e)=>setSearchInput(e.target.value)} placeholder='Search viigram'/>
        </div>
        {isClicked === true && 
