  ...
  return (
    <div className='h-[85%] w-full'>
        <div className='header p-2'>
            ...
            <div className='p-2
            '>
                <nav className='w-full flex justify-around shadow-md p-2'>
                    <div>
                        <svg aria-label="Posts" class="_8-yf5 " color="#8e8e8e" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <div>
                        <svg aria-label="Posts" class="_8-yf5 " color="#0095f6" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
                ...
                <div className='posts grid grid-cols-2 gap-[2px] p-2'>
